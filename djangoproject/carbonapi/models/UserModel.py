...
class Group(models.Model):
    ...
    permissions = models.ManyToManyField(Permission, through='Group_permission')
...
class Group_permission(models.Model):
    ...
    permission = models.ForeignKey(Permission, on_delete=models.PROTECT, db_column='permission')
...
class User(AbstractBaseUser):
    ...
    def has_perm(self, perm): return self.group.permissions.filter(permission_name=perm).exists()
